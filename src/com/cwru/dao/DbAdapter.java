...
public class DbAdapter {
    ...
    public long createExercise(Exercise ex) {
    	...
    	initialValues.put("comment", ex.getComment() != null ? ex.getComment() : null);
    ...
    public boolean deleteExercise(long exID) {
    	...
    	return db.update(DATABASE_TABLE_EXERCISE, args, "id = " + exID, null) > 0;
    }
    ...
    public boolean deleteSet(long setID) {
    	return db.delete(DATABASE_TABLE_SET, "id = " + setID, null) > 0;
    }
    ...
    public boolean updateSet(Set set) {
    	...
    	return db.update(DATABASE_TABLE_SET, args, "id = " + set.getId(), null) > 0;
    }    
